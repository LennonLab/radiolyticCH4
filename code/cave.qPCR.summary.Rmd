...
```{r}
mob <- read.delim("data/qPCR/mob.rabund.txt", sep =" ", stringsAsFactors = FALSE) 
rock.names <- read.delim("data/qPCR/sample.by.rock.txt", stringsAsFactors = FALSE, header = FALSE) 
...
semMC.gram <- sem((c(rekMC1, relMC2, relMC3)))

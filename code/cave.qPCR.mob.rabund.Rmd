...
## Read Microbial data
```{r}
mob <- read.delim("data/qPCR/mob.661.out.txt", sep =" ", stringsAsFactors = FALSE) 
eub <- read.delim("data/qPCR/20150813_VN_EUB_qPCR.txt", stringsAsFactors = FALSE) 
```
...
write.table(t.m.rabund, file = "data/qPCR/mob.rabund.txt")
```

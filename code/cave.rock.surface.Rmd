...
data <- read.table("data/areas/surface.area.txt", sep="\t", header=TRUE)
...
write.table(surface.area.final, file = "data/areas/surface.area.final.txt", sep="\t")
```
